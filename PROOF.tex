...
every admissible sequence of interpolants. This also answers
Erd\H{o}s Problem 1152 \cite{Erdos1152} in the stronger form
\eqref{eq:divergence}. The exceptional null set may depend on the
sequence \((p_n)\).

The contrast with fixed positive excess degree is provided by Erd\H{o}s,
...
Szabados and V\'ertesi \cite{SV90}. The same conclusion as
Theorem~\ref{thm:main} holds for polynomials with complex coefficients,
by applying the real statement to their real parts.
