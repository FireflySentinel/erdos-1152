...
\cite[p.~93, (3)--(4)]{Remez36}\footnote{An earlier version of this argument was developed with GPT-5.6.} yield
\[
...
Section~\ref{sec:baire} were developed with OpenAI Codex (GPT-6).
The formalization covers Lemma~\ref{lem:signs}, the scalar calculations
of Lemma~\ref{lem:equilibrium}, the polynomial and Remez deductions in
Section~\ref{subsec:high-potential} from the cardinal growth estimate,
and the finite construction and category argument. The Remez inequality
is an explicit classical input; the analytic derivation of the local
amplification conclusion remains outside the formalization.
